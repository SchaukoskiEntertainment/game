    ...
    return (
        <div style={Object.assign(eu_id == jogador.id ? euStyle : outroJogadorStyle)} >
            ...
            <div style={{ display: currentAnimation == "walking-right" || currentAnimation == "walking-left" ? "block" : "none" }}>
                <div style={{ transform: currentAnimation == "walking-right" ? "scaleX(1)" : "scaleX(-1)", animation: "animacaoAvatar 0.4s steps(4) infinite", position: "absolute", backgroundImage: `url(assets/new-body-walking.png)`, backgroundRepeat: "no-repeat", width: 62, height: 87, left: jogador.x, top: jogador.y }}></div>
            </div>
        </div>
    )
}